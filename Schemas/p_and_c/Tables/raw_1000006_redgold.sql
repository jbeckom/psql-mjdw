CREATE TABLE p_and_c.raw_1000006_redgold (
	...
	"Hierarchy Location Level 3" varchar(256) NOT NULL,
	...
	"Claimant Gender" varchar(256) NOT NULL,
	...
	"Body Part" varchar(256) NOT NULL,
...
/*** PERMISSIONS ***/
ALTER TABLE p_and_c.raw_1000006_redgold OWNER TO mj_admin;
GO

Grant select on table p_and_c.raw_1000006_redgold to rl_pc_data_analyst;
GO

Grant select on table p_and_c.raw_1000006_redgold to rl_pc_rpa_developer;
GO

Grant delete, update, insert, select on table p_and_c.raw_1000006_redgold to rpauser;
GO
GRANT SELECT ON p_and_c.raw_1000006_redgold to rl_p_and_c_r;
GO

GRANT INSERT ON p_and_c.raw_1000006_redgold to rl_p_and_c_a;
GO

GRANT UPDATE ON p_and_c.raw_1000006_redgold to rl_p_and_c_w;
GO

GRANT DELETE ON p_and_c.raw_1000006_redgold to rl_p_and_c_d;
GO