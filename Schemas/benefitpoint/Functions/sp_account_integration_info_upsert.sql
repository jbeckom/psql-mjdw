...
BEGIN 
	...
	SET 	 sagitta_client_id 				= excluded.sagitta_client_id
	...
	WHERE 	(account_integration_info.sagitta_client_id,account_integration_info.source_code,account_integration_info.primary_sales_lead_int_code,account_integration_info.primary_service_lead_int_code,account_integration_info.ams_customer_id,account_integration_info.ams_customer_number) 
		IS DISTINCT FROM 	(excluded.sagitta_client_id,excluded.source_code,excluded.primary_sales_lead_int_code,excluded.primary_service_lead_int_code,excluded.ams_customer_id,excluded.ams_customer_number);
