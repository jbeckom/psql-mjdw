CREATE OR REPLACE FUNCTION sagitta.tr_audit_ba_coverages_comml_auto_addl_cov_info_u() 
RETURNS TRIGGER 
LANGUAGE plpgsql 
AS $$
...
/*** PERMISSIONS ***/
ALTER FUNCTION sagitta.tr_audit_ba_coverages_comml_auto_addl_cov_info_u() OWNER TO mj_admin;
GO 

GRANT EXECUTE ON FUNCTION sagitta.tr_audit_ba_coverages_comml_auto_addl_cov_info_u() TO rl_sagitta_x;
GO 
