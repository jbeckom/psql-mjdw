create or replace function sagitta.tr_audit_gd_coverages_doc_coverage_info_u() 
returns trigger 
language plpgsql 
as $$ 
...
/*** PERMISSIONS ***/
alter function sagitta.tr_audit_gd_coverages_doc_coverage_info_u() owner to mj_admin;
go 

grant execute on function sagitta.tr_audit_gd_coverages_doc_coverage_info_u() to rl_sagitta_x;
go 